...
rabbitmqadmin --username=broker_admin --password=broker_admin --vhost=cluster_vhost declare queue name="log_queue"
...
rabbitmqadmin --username=broker_admin --password=broker_admin --vhost=cluster_vhost declare binding source="cluster_exchange" destination="log_queue" routing_key="#"
