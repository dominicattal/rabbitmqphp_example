...
rabbitmqadmin --username=broker_admin --password=broker_admin --vhost=it490 declare binding source="broker_exchange" destination="db_web_queue" routing_key="db_web"
rabbitmqadmin --username=broker_admin --password=broker_admin --vhost=it490 declare binding source="broker_exchange" destination="db_data_queue" routing_key="db_data"
